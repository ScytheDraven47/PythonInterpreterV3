...
import doctest
from strategy.validate_strategy import Age, Birthday, BMI, EmployeeID, Gender, Salary, Sales, ValidateContext
...
class Validate:
    ...
    #     # return valid_emp_id
    #     validate = ValidateContext(EmployeeID())
    #     return validate.validate_data(emp_id)
    #
    # @staticmethod
    ...
    #     False
    #     """
    #     valid_gender = bool(re.search("^([MF])$", str(gender).upper()))
    #     return valid_gender
    #
    # @staticmethod
    ...
    def validate_all(self, input_data):
        ...
        gender = ValidateContext(Gender())
        age = ValidateContext(Age())
        sales = ValidateContext(Sales())
        bmi = ValidateContext(BMI())
        salary = ValidateContext(Salary())
        birthday = ValidateContext(Birthday())
